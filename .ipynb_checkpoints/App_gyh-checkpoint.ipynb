 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "        {\"role\": \"assistant\", \"content\": \"Hola Carlos, ¿subiste los planos revisados de la Torre B?\"},\n",
    "        {\"role\": \"user\", \"content\": \"Sí, están en la carpeta 'Ingeniería/Versión Final'.\"}\n",
    "    ]\n",
    "\n",
    "# --- FUNCIONES DE VISTAS ---\n",
    "\n",
    ...
    "    col2.metric(\"Días Sin Accidentes\", \"128\", \"Meta: 365\")\n",
    ...
    "    render_kpis()\n",
    "    \n",
    "    st.markdown(\"### 🏗️ Estado de Proyectos\")\n",
    ...
    "        st.warning(\"**Visita Técnica:** Mañana 10:00 AM - Inspectores Municipales.\")\n",
    "    \n",
    "    with col_grafico:\n",
    ...
    "\n",
    "def view_worker():\n",
    "    st.title(\"👷 Portal del Trabajador\")\n",
    "    \n",
    "    col1, col2 = st.columns(2)\n",
    "    with col1:\n",
    "        if st.button(\"📍 MARCAR ENTRADA (GPS)\", type=\"primary\", use_container_width=True):\n",
    "            with st.spinner(\"Localizando...\"):\n",
    "                time.sleep(1)\n",
    "            st.success(\"✅ Entrada registrada a las 08:00 AM\")\n",
    "            \n",
    "    with col2:\n",
    "        if st.button(\"⚠️ REPORTAR INCIDENTE\", type=\"secondary\", use_container_width=True):\n",
    "            st.error(\"Formulario de incidente abierto\")\n",
    "\n",
    "    st.markdown(\"### 📋 Mis Tareas de Hoy\")\n",
    "    tasks = pd.DataFrame({\n",
    ...
    "    st.table(tasks)\n",
    "\n",
    "    st.info(\"💰 **Aviso:** El bono de producción se pagará este viernes 30.\")\n",
    "\n",
    "def view_client():\n",
    ...
    "    col1, col2 = st.columns(2)\n",
    "    with col1:\n",
    "        st.progress(65, text=\"Avance Físico: 65%\")\n",
    "        st.progress(58, text=\"Avance Financiero: 58%\")\n",
    "    \n",
    "    st.divider()\n",
    "    \n",
    "    tabs = st.tabs([\"📸 Galería de Avance\", \"📝 Requisitos y Cambios\"])\n",
    "    \n",
    "    with tabs[0]:\n",
    "        st.markdown(\"Vista aérea del proyecto\")\n",
    ...
    "        reqs = pd.DataFrame({\n",
    "            \"Requisito\": [\"Cambio Terminaciones Hall\", \"Ampliación Estacionamiento\"],\n",
    "            \"Prioridad\": [\"Alta\", \"Media\"],\n",
    "            \"Costo\": [\"+$1.2M\", \"TBD\"],\n",
    "            \"Estado\": [\"Aprobado\", \"En Evaluación\"]\n",
    "        })\n",
    "        st.dataframe(reqs, use_container_width=True)\n",
    "\n",
    "def view_chat():\n",
    "    st.title(\"💬 Chat Interno de Obra\")\n",
    "    \n",
    "    # Mostrar historial\n",
    ...
    "        # Respuesta simualda\n",
    "        time.sleep(1)\n",
    "        response = \"Recibido. Lo revisaré en la reunión de coordinación.\"\n",
    ...
    "        \n",
    "    selected_page = st.radio(\"Navegación\", menu_options)\n",
    "    \n",
    "    st.divider()\n",
    ...
    "        view_chat()\n",
    "    else:\n",
    "        st.info(f\"Módulo de {selected_page} en desarrollo\")\n",
    "        \n",
    "elif selected_role == \"WORKER\":\n",
    "    view_worker()\n",
    "    \n",
